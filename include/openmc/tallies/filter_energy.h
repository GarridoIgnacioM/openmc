...
class EnergyCharFilter : public Filter {
public:
  //----------------------------------------------------------------------------
  // Constructors, destructors

  ~EnergyCharFilter() = default;

  //----------------------------------------------------------------------------
  // Methods

  std::string type_str() const override { return "energychar"; }
  FilterType type() const override { return FilterType::ENERGYCHAR; }
